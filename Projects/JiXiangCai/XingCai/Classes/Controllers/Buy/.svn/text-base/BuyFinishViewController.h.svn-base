...
@interface BuyFinishViewController : DerivedViewController<UIAlertViewDelegate>
{

}
@property (weak, nonatomic) BuyChooseViewController *buyChooseViewController;
@property (weak, nonatomic) IBOutlet UIImageView *zhuiqiBG;
@property (weak, nonatomic) IBOutlet UIImageView *beishuBG;
@property (weak, nonatomic) IBOutlet UILabel *balanceLabel;
@property (weak, nonatomic) IBOutlet UILabel *balance_yuan;
...
@property (weak, nonatomic) IBOutlet UIView *containerView;
@property (weak, nonatomic) IBOutlet UIButton *zhuihaoBG;
@property (weak, nonatomic) IBOutlet UIButton *toubeiBG;
...
@property (nonatomic, assign)long long times;                                 //追号倍数
@property (nonatomic, assign)long long time_s;                                 //单个玩法倍数
