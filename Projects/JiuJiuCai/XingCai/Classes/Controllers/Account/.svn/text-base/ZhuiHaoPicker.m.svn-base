...
@interface ZhuiHaoPicker()<UIPickerViewDelegate, UIPickerViewDataSource>
{
    NSArray *dates;
    int selectRowNo;
}
...
{
    selectRowNo = row;
    [delegate zhuiHaoPicker:self didSelectDateWithName:self.selectedDate];
}
