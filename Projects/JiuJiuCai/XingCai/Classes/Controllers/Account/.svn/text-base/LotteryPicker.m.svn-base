...
@interface LotteryPicker()<UIPickerViewDelegate, UIPickerViewDataSource>
{
    NSArray *dates;
    int selectRowNo;
}
...
{
    selectRowNo = (int) row;
    [delegate lotteryPicker:self didSelectDateWithName:self.selectedDate];
}
