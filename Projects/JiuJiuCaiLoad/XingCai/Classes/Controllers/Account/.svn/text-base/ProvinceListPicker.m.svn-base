...
@interface ProvinceListPicker()<UIPickerViewDelegate, UIPickerViewDataSource>
{
    NSArray *dates;
    int selectRowNo;
}
...
@implementation ProvinceListPicker
@synthesize delegate;
...
{
    selectRowNo = (int) row;
    [delegate provinceListPicker:self didSelectDateWithName:self.selectedDate];
}
