...
@interface BankListPicker()<UIPickerViewDelegate, UIPickerViewDataSource>
{
    NSArray *dates;
    int selectRowNo;
}
...
{
    selectRowNo = (int) row;
    [delegate bankListPicker:self didSelectDateWithName:self.selectedDate];
}
