...
- (void)viewDidLoad
{
    ...
    self.tView.size = CGSizeMake(320, 524);
...
-(void)modelCellFill:(UITableViewCell *)cell Object:(MsgListObject *)object rowInd:(NSInteger)rowIndex
{
    ...
    if(contentLab == nil)
    {
        contentLab = [[UILabel alloc] initWithFrame:CGRectMake(20, 1, 200, 63)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (msgListArr.count>0 && [msgListArr isKindOfClass:[NSArray class]])
    {
        ...
        tmp.entryStr = [msgListObject msgid];
