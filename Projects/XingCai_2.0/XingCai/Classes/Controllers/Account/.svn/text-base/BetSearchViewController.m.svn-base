...
- (void)loadData:(NSString *)sDate endDate:(NSString *)eDate lotteryid:(NSString *)lotteryid withPageNume:(NSString *)page
{
    if (mark==YES)
    {
     ...
     [[AppHttpManager sharedManager] gouCaiChaXunWithStartTime:[sDate stringByAppendingString:@" 02:20:00"] endTime:[eDate stringByAppendingString:@" 02:20:00"] lotteryid:lotteryid Page:page Block:^(id JSON, NSError *error)
     {
