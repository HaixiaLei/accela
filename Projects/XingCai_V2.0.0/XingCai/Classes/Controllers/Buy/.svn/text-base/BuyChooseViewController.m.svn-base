...
//  [self setupNavigationBarTitle:@"重庆时时彩" tintColor:GUI_COLOR_NAVIGATION_BAR_TEXT navigationBarHidden:NO navigationBarTranslucent:NO withBackButtonItem:BackActionPop];
    ...
    xlPicIV = [UIButton buttonWithType:UIButtonTypeCustom];
    [xlPicIV setFrame:CGRectMake(140, 18, 16, 12)];
    [xlPicIV setBackgroundImage:[UIImage imageNamed:@"btn_down"] forState:UIControlStateNormal];
    [xlPicIV addTarget:self action:@selector(selectGame:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)gotoShowPlayMethodView
{
    ...
    {
        [xlPicIV setBackgroundImage:[UIImage imageNamed:@"btn_up"] forState:UIControlStateNormal];
        lockV.hidden = NO;
    }
    else
    {
