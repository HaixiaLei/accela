...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^ {
        ...
        appearance.viewBackgroundColor = [UIColor colorWithWhite:0.954 alpha:1.000];
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle
{
    ...
    messageLabel.font = [UIFont fontWithName:@"STHeiti-Light" size:17.f];
...
+ (void)showBackground
{
    CXAlertBackgroundWindow *alertWindow = [CXAlertBackgroundWindow shared];
