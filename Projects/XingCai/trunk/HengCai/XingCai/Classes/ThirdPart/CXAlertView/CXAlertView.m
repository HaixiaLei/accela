...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^ {
        ...
        appearance.viewBackgroundColor = [UIColor colorWithRed:51.0/255 green:48.0/255 blue:49.0/255 alpha:1.0];
        appearance.titleColor = [UIColor colorWithRed:150.0/255 green:150.0/255 blue:150.0/255 alpha:1.0];
        appearance.titleFont = [UIFont fontWithName:@"STHeiti-Medium" size:20.f];
        appearance.buttonFont = [UIFont fontWithName:@"STHeiti-Light" size:17.f];
        appearance.buttonColor = [UIColor colorWithRed:254.0/255 green:215.0/255 blue:36.0/255 alpha:1.0];
        appearance.cancelButtonColor = [UIColor colorWithRed:254.0/255 green:215.0/255 blue:36.0/255 alpha:1.0];
        appearance.cancelButtonFont = [UIFont fontWithName:@"STHeiti-Light" size:17.f];
        appearance.customButtonColor = [UIColor colorWithRed:255.0/255 green:15.0/255 blue:27.0/255 alpha:1.0];
        appearance.customButtonFont = [UIFont fontWithName:@"STHeiti-Light" size:17.f];
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle
{
    ...
    messageLabel.textColor = [UIColor colorWithRed:255.0/255 green:203.0/255 blue:46.0/255 alpha:1.0];
