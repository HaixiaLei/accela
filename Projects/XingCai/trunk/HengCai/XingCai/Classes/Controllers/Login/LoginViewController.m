...
{
    //测试************
//    AppAlertViewTestViewController *testVC = [[AppAlertViewTestViewController alloc] initWithNibName:@"AppAlertViewTestViewController" bundle:nil];
...
//            [[NSUserDefaults standardUserDefaults] synchronize];
            ...
            //这里以后需要判断玩法版本，如果本地有玩法，切版本号一致，就不再刷新
            //请求彩种
//            if (![[AppCacheManager sharedManager] lotteryListExist]) {
...
//            else
//            {
//                [[AppCacheManager sharedManager] updateLotteryListWithBlock:nil];
//                [self dismissViewControllerAnimated:YES completion:^(void){
//                }];
//            }
        }
