...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^ {
        ...
        appearance.viewBackgroundColor = [UIColor colorWithRed:255.0f/255 green:255.0f/255 blue:255.0f/255 alpha:0.1f];
        appearance.titleColor = [UIColor colorWithRed:255.0/255 green:114.0/255 blue:6.0/255 alpha:1.0];
        appearance.titleFont = [UIFont fontWithName:@"STHeiti-Medium" size:15.f];
        appearance.buttonFont = [UIFont fontWithName:@"STHeiti-Light" size:15.f];
        appearance.buttonColor = [UIColor colorWithRed:96.0/255 green:96.0/255 blue:96.0/255 alpha:1.0];
        appearance.cancelButtonColor = [UIColor colorWithRed:96.0/255 green:96.0/255 blue:96.0/255 alpha:1.0];//单个确定（取消）
        appearance.cancelButtonFont = [UIFont fontWithName:@"STHeiti-Light" size:15.f];
        appearance.customButtonColor = [UIColor colorWithRed:255.0/255 green:114.0/255 blue:6.0/255 alpha:1.0];//确定
        appearance.customButtonFont = [UIFont fontWithName:@"STHeiti-Light" size:15.f];
        appearance.cornerRadius = 3;
        appearance.shadowRadius = 3;
    });
}
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle
{
    ...
    messageLabel.font = [UIFont fontWithName:@"STHeiti-Light" size:13.f];
    messageLabel.textColor = [UIColor colorWithRed:96.0/255 green:96.0/255 blue:96.0/255 alpha:1.0];
...
- (void)setupContainerView
{
    ...
    //描边
//    self.containerView.layer.borderColor = [[UIColor colorWithRed:29.0/255 green:25.0/255 blue:26.0/255 alpha:1.000] CGColor];
//    self.containerView.layer.borderWidth = 1;
//    //加入背景图
//    UIImage *image = [UIImage imageNamed:@"bk_dialog_bg"];
...
//    _containerBgImageView = [[UIImageView alloc] initWithFrame:frame];
//    _containerBgImageView.image = image;
//    _containerBgImageView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
//    [_containerView addSubview:_containerBgImageView];
...
- (void)updateBottomScrollView
{
    ...
    _bottomScrollView.frame = CGRectMake( 0, y, self.containerWidth, [self heightForBottomScrollView] + 1);//height+1是为了不覆盖topLine
...
- (void)addButtonWithTitle:(NSString *)title type:(CXAlertViewButtonType)type handler:(CXAlertButtonHandler)handler font:(UIFont *)font
{
    ...
    if ([_buttons count] == 0) {
        ...
        button.frame = CGRectMake( self.containerWidth/4, 1, self.containerWidth/2, self.buttonHeight);//y是1是为了不覆盖topLine
    }
    else {
        ...
        button.frame = CGRectMake( last_x + self.containerWidth/2, 1, self.containerWidth/2, self.buttonHeight);//y是1是为了不覆盖topLine
        button.alpha = 0.;
        if (self.isVisible) {
            [UIView animateWithDuration:0.3 animations:^{
                firstButton.frame = newFrame;
                button.alpha = 1.;
                button.frame = CGRectMake( last_x, 1, self.containerWidth/2, self.buttonHeight);//y是1是为了不覆盖topLine
            }];
        }
        else {
            firstButton.frame = newFrame;
