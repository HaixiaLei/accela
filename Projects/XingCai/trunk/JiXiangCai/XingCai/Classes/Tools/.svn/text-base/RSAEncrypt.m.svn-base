...
- (id)init {
    ...
    self = [super init];
    NSString *publicKeyPath = [[NSBundle mainBundle] pathForResource:PubKeyFileName ofType:PubKeyFileType];
    //從檔案讀取公鑰
...
#pragma mark - convert NSData to NSString
...
- (void)dealloc{
    ...
    CFBridgingRelease(trust);
    CFBridgingRelease(policy);
