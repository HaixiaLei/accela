...
@interface BetRecordsViewController : DerivedViewController<UITableViewDataSource, UITableViewDelegate, LotteryPickerDelegate, TDDatePickerControllerDelegate>
{
