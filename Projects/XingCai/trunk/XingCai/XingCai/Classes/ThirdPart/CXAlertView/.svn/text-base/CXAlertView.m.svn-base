...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^ {
        ...
        appearance.titleColor = [UIColor colorWithRed:0.0/255 green:0.0/255 blue:0.0/255 alpha:1.0];
        ...
        appearance.buttonColor = [UIColor blueColor];
        appearance.cancelButtonColor = [UIColor colorWithRed:0.0/255 green:0.0/255 blue:255.0/255 alpha:1.0];
        appearance.cancelButtonFont = [UIFont fontWithName:@"STHeiti-Light" size:17.f];
        appearance.customButtonColor = [UIColor blueColor];
...
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle
{
    ...
    messageLabel.textColor = [UIColor colorWithRed:0.0/255 green:0.0/255 blue:0.0/255 alpha:1.0];
