...
-(void)modelCellFill:(UITableViewCell *)cell Object:(NoticeListObject *)object rowInd:(NSInteger)rowIndex
{
    ...
    if(contentLab == nil)
    {
        contentLab = [[UILabel alloc] initWithFrame:CGRectMake(20, 0, 270, 83)];
        contentLab.tag = BASETAG1+1;
        contentLab.font = [UIFont systemFontOfSize:14];
        contentLab.textColor = [UIColor colorWithRed:(87/255.0) green:(83/255.0) blue:(80/255.0) alpha:1];
        contentLab.backgroundColor = [UIColor clearColor];
        contentLab.lineBreakMode = UILineBreakModeWordWrap;
        contentLab.numberOfLines = 0;
        [cell addSubview:contentLab];
    }
    contentLab.text = [[[NSString stringWithFormat:@"%li",(long)rowIndex] stringByAppendingString:@"、"] stringByAppendingString:[object subject]];
}
//返回某个表视图有多少行数据
