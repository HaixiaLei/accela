...
//     [UIFont fontWithName:@"AmericanTypewriter" size:0.0], UITextAttributeFont,
    ...
    if(IOS_VERSION<7.0){
        ...
        [threeNavigationController.tabBarItem setFinishedSelectedImage:[[UIImage imageNamed:@"Icon_user_click"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]withFinishedUnselectedImage:[[UIImage imageNamed:@"Icon_user_normal"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
        [fourNavigationController.tabBarItem setFinishedSelectedImage:[[UIImage imageNamed:@"icon_more_click"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]withFinishedUnselectedImage:[[UIImage imageNamed:@"icon_more_normal"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    }
    //tarbar上端阴影
