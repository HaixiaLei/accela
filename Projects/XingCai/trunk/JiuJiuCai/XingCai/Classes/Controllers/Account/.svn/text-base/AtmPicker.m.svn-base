...
@interface AtmPicker()<UIPickerViewDelegate, UIPickerViewDataSource>
{
    NSArray *dates;
    int selectRowNo;
}
...
{
    selectRowNo = row;
    [delegate atmPicker:self didSelectDateWithName:self.selectedDate];
}
