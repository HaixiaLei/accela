...
- (void)viewDidLoad
{
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"firstLaunch"]||(![latestBuild isEqualToString:build]||![latestVersion isEqualToString:vesion])) {
        ...
        UIImage *image1 =[UIImage imageNamed:@"activity_1334_bk01@2x.jpg"];
        UIImage *image2 =[UIImage imageNamed:@"activity_1334_bk02@2x.jpg"];
        UIImage *image3 =[UIImage imageNamed:@"activity_1136_bk03@2x.jpg"];
