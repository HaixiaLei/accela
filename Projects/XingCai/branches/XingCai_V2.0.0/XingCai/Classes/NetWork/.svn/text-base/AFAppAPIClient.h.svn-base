...
#ifndef OnLine
//static NSString * const kAFAppAPIBaseURLString = @"http://pre.123ssc.net/feed/";
//static NSString * const kAFAppAPIBaseURLString = @"http://caix8.com/feed/";
//static NSString * const kAFAppAPIBaseURLString = @"http://192.168.40.98/feed/";
//static NSString * const kAFAppAPIBaseURLString = @"http://192.168.20.252/feed/";
//static NSString * const kAFAppAPIBaseURLString = @"http://121.96.70.58/feed/";
static NSString * const kAFAppAPIBaseURLString = @"http://10.60.20.36/feed/"; // V
...
typedef NS_ENUM(NSInteger,AppServerError)
{
    ...
    /**总代暂无法投注*/
    AppServerErrorAgentCanNotBuy    = 801,
};
