...
- (void)getPlayInfomation
{
    ...
    switch (self.infoType)
    {
        ...
        {
            [self setupNavigationBarTitle:@"玩法说明" tintColor:GUI_COLOR_NAVIGATION_BAR_TEXT navigationBarHidden:NO navigationBarTranslucent:NO withBackButtonItem:BackActionPop];
            //玩法说明
        ...
        case InfoTypeAnswer:
        {
            [self setupNavigationBarTitle:@"常见问题说明" tintColor:GUI_COLOR_NAVIGATION_BAR_TEXT navigationBarHidden:NO navigationBarTranslucent:NO withBackButtonItem:BackActionPop];
            //常见问题说明
