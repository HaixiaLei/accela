...
- (void)loadData:(NSString *)sDate endDate:(NSString *)eDate lotteryid:(NSString *)lotteryid withPage:(NSString*)page
{
    ...
    [[AppHttpManager sharedManager] zhuiHaoChaXunWithStartTime:[sDate stringByAppendingString:@" 02:20:00"] endTime:[eDate stringByAppendingString:@" 02:20:00"] lotteryid:lotteryid Page:page Block:^(id JSON, NSError *error)
     {
