...
- (void)viewDidLoad
{
    ...
    [self getInfo];
    [self setupNavigationBarTitle:@"提款中心" tintColor:GUI_COLOR_NAVIGATION_BAR_TEXT navigationBarHidden:NO navigationBarTranslucent:NO withBackButtonItem:BackActionPop];
...
//        NSLog(@"%@",availableBalanceLab.text);
        ...
        id maxM = [[banksArray objectAtIndex:0] objectForKey:@"max_money"];
        ...
        id minM = [[banksArray objectAtIndex:0] objectForKey:@"min_money"];
