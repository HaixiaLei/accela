...
static NSString * const kAFAppAPIBaseURLString = @"http://192.168.20.251:808/feed/";    //d,开发环境
//static NSString * const kAFAppAPIBaseURLString = @"http://192.168.40.108/feed/";      //v
