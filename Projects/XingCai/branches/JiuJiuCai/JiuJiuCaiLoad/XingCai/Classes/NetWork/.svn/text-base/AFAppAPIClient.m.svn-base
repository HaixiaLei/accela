...
- (AppRequest *)getRequestWithPath:(NSDictionary *)pathParameters Parameters:(NSDictionary *)parameters
{
    ...
    [self request:request setBody:parameters];
...
- (void)request:(NSMutableURLRequest *)request setBody:(NSDictionary *)parameters
{
    if (parameters) {
...
- (NSString *)getSessionID
{
    if (!_sessionID) {
        ...
        if (!sessionID) {
            DDLogWarn(@"无法获取sessionID，这里需要跳转到登录页面");
        }
        else
        {
...
- (void)requestFinished:(NSURLRequest *)request json:(id)JSON
{
    ...
    if ([JSON isKindOfClass:[NSDictionary class]] && [JSON objectForKey:@"msg"]) {
        ...
        if (appRequest.method == APIMethodKeZhuiHaoJiangQi || appRequest.method == APIMethodJiangQi || appRequest.method == APIMethodMenuAndRule || appRequest.method == APIMethodVersionNumber || appRequest.method == APIMethodBalance|| appRequest.method == APIMethodGetAvatar) {
            ;
        }
...
- (void)requestFailed:(NSURLRequest *)request error:(NSError *)error
{
    ...
    DDLogError(@"requestFailed: %@,domain:%@,code:%d", [error localizedDescription], error.domain, error.code);
...
{
    NSDictionary *userInfo = [NSDictionary dictionaryWithObject:@"Error from server" forKey:NSLocalizedFailureReasonErrorKey];
...
- (void)updateAvatarWithId:(NSString *)avatarId Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodUpdateAvatar;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)getAvatarWithBlock:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodGetAvatar;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)betDetail_WithProjectid:(NSString *)projectid Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodTouZhuXiangQing;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)cancelOrder_WithProjectid:(NSString *)projectid Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodCheDan;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)traceDetail_WithTaskId:(NSString *)taskId Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodZhuiHaoMingXiChaXun;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)cancelTrace_WithTaskId:(NSString *)taskId detailId:(NSString *)detailId Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodZhongZhiZhuiHao;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)getAdDetailWithActivityId:(NSString *)activityId Block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodGetAdDetail;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)bankListWithBlock:(void (^)(id JSON, NSError *error))block
{
    NSString *sessionID = [self getSessionID];
    NSMutableDictionary *pathParams = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                       @"emaildeposit",                             @"controller",
                                       @"main",                                     @"action",
                                       sessionID,                                   @"sess",
                                       nil];
    
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:nil];
    request.method = APIMethodBankList;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)bankInfoWithBankCode:(NSString *)bankCode block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodBankInfo;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)loadConfirmWithBankCode:(NSString *)bankCode bankId:(NSString *)bankId bankIdInBankInfo:(NSString *)bankIdInBankInfo amount:(NSString *)amount block:(void (^)(id JSON, NSError *error))block
{
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   @"load",                                     @"flag",
                                   bankId,                                      @"bid",
                                   bankIdInBankInfo,                            @"bank",
                                   amount,                                      @"amount",
                                   nil];
    
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodLoadConfirm;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)provinceListWithBlock:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodProvinceList;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)cityListWithProvince:(NSString *)province block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodCityList;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)addBankCardWithBankUniqueCode:(NSString *)bankUniqueCode province:(NSString *)province cityUniqueCode:(NSString *)cityUniqueCode branch:(NSString *)branch accountName:(NSString *)accountName account:(NSString *)account checkCode:(NSString *)checkCode bankCheckCode:(NSString *)bankCheckCode block:(void (^)(id JSON, NSError *error))block
{
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   account,                                     @"account",
                                   checkCode,                                   @"check",
                                   bankCheckCode,                               @"check_bank",
                                   nil];
    
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodAddBankCard;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)comfirmCardWithBankName:(NSString *)bankName bankId:(NSString *)bankId province:(NSString *)province provinceId:(NSString *)provinceId city:(NSString *)city cityId:(NSString *)cityId bankBranch:(NSString *)bankBranch account:(NSString *)account accountName:(NSString *)accountName addBankCode:(NSString *)addBankCode block:(void (^)(id JSON, NSError *error))block
{
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   ...
                                   accountName,                                 @"account_name",
                                   account,                                     @"account",
                                   addBankCode,                                 @"add_bank_code",
                                   nil];
    
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodComfirmCard;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)checkCardWithAccount:(NSString *)account accountName:(NSString *)accountName block:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodCheckCard;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)hasBindWithBlock:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodHasBind;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)hasWithdrawPwdWithBlock:(void (^)(id JSON, NSError *error))block
{
    ...
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodHasWithdrawPwd;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
...
- (void)setWithdrawPwdWithNewPassword:(NSString *)newPassword block:(void (^)(id JSON, NSError *error))block
{
    ...
    NSString *md5Password = [MyMD5 md5:newPassword];
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   md5Password,                                 @"secpass",
                                   nil];
    
    AppRequest *request = [self getRequestWithPath:pathParams Parameters:params];
    request.method = APIMethodSetWithdrawPwd;
    [self request:request sucessBlock:nil failBlock:nil finishBlock:block];
}
@end
