...
@class CityListPicker;

@protocol CityListPickerDelegate <UIPickerViewDelegate>
- (void)cityListPicker:(CityListPicker *)picker didSelectDateWithName:(NSString *)name;
@end

@interface CityListPicker : UIPickerView
...
@property (nonatomic, AH_WEAK) id<CityListPickerDelegate> delegate;
